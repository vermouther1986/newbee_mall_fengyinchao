...
public class Review {
	...
	public String toString() {
		...
		builder.append(", rating1=");
		builder.append(rating1);
		builder.append(", rating2=");
		builder.append(rating2);
		builder.append(", rating3=");
		builder.append(rating3);
		builder.append(", rating4=");
		builder.append(rating4);
		builder.append(", rating5=");
		builder.append(rating5);
		builder.append(", countReview=");
		builder.append(countReview);
		builder.append(", avgRating=");
		builder.append(avgRating);
		builder.append(", allRating=");
		builder.append(allRating);
		builder.append(", countRating=");
		builder.append(countRating);
		builder.append(", allReview=");
		builder.append(allReview);
		...
		builder.append(photo4);
		builder.append(", photo5=");
		builder.append(photo5);
		builder.append(", reviewDate=");
		builder.append(reviewDate);
		builder.append(", proved=");
		builder.append(proved);
		builder.append("]");
